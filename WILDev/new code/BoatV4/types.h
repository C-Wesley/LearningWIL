    ...
    class Point
    {
        ...
        public:
            ...
            double distanceTo(const Point& other) const 
            {
                ...
                // Serial.println("=====Distance To======");
                // Serial.print("This Lat: "); Serial.print(this->latitude); 
                // Serial.print(" This Lon: "); Serial.println(this->longitude);

                // Serial.print("Othr Lat: "); Serial.print(other.latitude);
                // Serial.print("Othr Lon: "); Serial.println(other.longitude);
