...
#define CONFIG_H 
    ...
    constexpr int WAYPOINT_DISTANCE_THRESHOLD = 6.0; // 6 meters 
    ...
    constexpr int ESC_FORWARD         = 1650;
    constexpr int ESC_INIT_TIME_MS    = 3000;
    ...
    ========================= */
    constexpr unsigned long MAX_WAIT_MS = 500; // Ammount of time to wait for full packet to be recieved before moving on. 
    constexpr unsigned long CONTROLLER_POLLING_MS = 100; // How often to poll the controller 

    constexpr unsigned long GPS_POLLING_MS = 800;
    constexpr unsigned long GPS_ERROR_POLLING_MS = 8000; // Wait 8 seconds before updating our heading error
#endif